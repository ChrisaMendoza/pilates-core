...
import { sampleWithRequiredData } from '../studio.test-samples';
...
describe('Studio Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.studios()[0]).toEqual(expect.objectContaining({ id: 24793 }));
  });

  describe('trackId', () => {
    it('should forward to studioService', () => {
      const entity = { id: 24793 };
      jest.spyOn(service, 'getStudioIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStudioIdentifier).toHaveBeenCalledWith(entity);
